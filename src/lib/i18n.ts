...
const en: Dict = {
  ...
  volume: "volume",
  from_shelf: "from the shelf of CookNotes",
  contents: "Contents",
  ...
  share_sheet_hint: "anyone who opens this link in CookNotes will get a copy of the recipe.",
  ...
  ach_first_page: "The First Page",
  ach_first_page_d: "Clip your very first recipe.",
  ach_collector: "The Collector",
  ach_collector_d: "Gather {n} recipes in your library.",
  ach_curator: "The Curator",
  ach_curator_d: "Gather {n} recipes in your library.",
  ach_archivist: "The Archivist",
  ach_archivist_d: "Gather {n} recipes in your library.",
  ach_legend: "Legendary Library",
  ach_legend_d: "Gather {n} recipes in your library.",
  ach_meatlover: "Meat Lover",
  ach_meatlover_d: "Keep {n} hearty meat recipes.",
  ach_grill_master: "Grill Master",
  ach_grill_master_d: "Keep {n} meat recipes in all.",
  ach_garden: "From the Garden",
  ach_garden_d: "Keep {n} vegetarian or vegan recipes.",
  ach_catch: "Good Catch",
  ach_catch_d: "Keep {n} fish or seafood recipes.",
  ach_sweet_tooth: "Sweet Tooth",
  ach_sweet_tooth_d: "Keep {n} desserts and sweets.",
  ach_baker: "The Baker",
  ach_baker_d: "Keep {n} baked goods — bread, dough, pastry.",
  ach_pasta_maker: "Pasta Maker",
  ach_pasta_maker_d: "Keep {n} pasta or noodle recipes.",
  ach_fire_eater: "Fire Eater",
  ach_fire_eater_d: "Keep {n} spicy recipes.",
  ach_soup_season: "Soup Season",
  ach_soup_season_d: "Keep {n} soups and stews.",
  ach_early_riser: "Early Riser",
  ach_early_riser_d: "Keep {n} breakfast recipes.",
  ach_quick_hands: "Quick Hands",
  ach_quick_hands_d: "Keep {n} recipes ready in 20 minutes.",
  ach_slow_cook: "Slow and Low",
  ach_slow_cook_d: "Keep {n} recipes that take 90 minutes or more.",
  ach_critic: "The Critic",
  ach_critic_d: "Rate {n} recipes.",
  ach_perfectionist: "Five Stars",
  ach_perfectionist_d: "Give {n} recipes a perfect five.",
  ach_annotator: "In the Margins",
  ach_annotator_d: "Add your own notes to {n} recipes.",
  ach_chef_student: "The Chef's Student",
  ach_chef_student_d: "Consult the chef on {n} recipes.",
  ach_world_tour: "World Tour",
  ach_world_tour_d: "Collect recipes from {n} different cuisines.",
};
...
const he: Dict = {
  ...
  // הישגים
  ach_title: "הישגים",
  ach_first_page: "הדף הראשון",
  ach_first_page_d: "הוסיפו מתכון ראשון לספרייה.",
  ach_collector: "האספן",
  ach_collector_d: "אספו {n} מתכונים בספרייה.",
  ach_curator: "האוצר",
  ach_curator_d: "אספו {n} מתכונים בספרייה.",
  ach_archivist: "הארכיונאי",
  ach_archivist_d: "אספו {n} מתכונים בספרייה.",
  ach_legend: "ספרייה אגדית",
  ach_legend_d: "אספו {n} מתכונים בספרייה.",
  ach_meatlover: "חובב בשר",
  ach_meatlover_d: "שמרו {n} מתכוני בשר משביעים.",
  ach_grill_master: "מלך המנגל",
  ach_grill_master_d: "שמרו {n} מתכוני בשר בסך הכול.",
  ach_garden: "היישר מהגינה",
  ach_garden_d: "שמרו {n} מתכונים צמחוניים או טבעוניים.",
  ach_catch: "שלל הדיג",
  ach_catch_d: "שמרו {n} מתכוני דגים ופירות ים.",
  ach_sweet_tooth: "שן מתוקה",
  ach_sweet_tooth_d: "שמרו {n} קינוחים ומתוקים.",
  ach_baker: "האופה",
  ach_baker_d: "שמרו {n} מאפים — לחם, בצק ומאפה.",
  ach_pasta_maker: "אמן הפסטה",
  ach_pasta_maker_d: "שמרו {n} מתכוני פסטה או אטריות.",
  ach_fire_eater: "אוכל אש",
  ach_fire_eater_d: "שמרו {n} מתכונים חריפים.",
  ach_soup_season: "עונת המרקים",
  ach_soup_season_d: "שמרו {n} מרקים ותבשילים.",
  ach_early_riser: "משכימי קום",
  ach_early_riser_d: "שמרו {n} מתכוני ארוחת בוקר.",
  ach_quick_hands: "ידיים זריזות",
  ach_quick_hands_d: "שמרו {n} מתכונים שמוכנים ב־20 דקות.",
  ach_slow_cook: "לאט ובנחת",
  ach_slow_cook_d: "שמרו {n} מתכונים שלוקחים שעה וחצי ומעלה.",
  ach_critic: "המבקר",
  ach_critic_d: "דרגו {n} מתכונים.",
  ach_perfectionist: "חמישה כוכבים",
  ach_perfectionist_d: "העניקו ל־{n} מתכונים דירוג מושלם.",
  ach_annotator: "בשולי הדף",
  ach_annotator_d: "הוסיפו הערות אישיות ל־{n} מתכונים.",
  ach_chef_student: "תלמיד השף",
  ach_chef_student_d: "התייעצו עם השף על {n} מתכונים.",
  ach_world_tour: "מסע מסביב לעולם",
  ach_world_tour_d: "אספו מתכונים מ־{n} מטבחים שונים.",
};
