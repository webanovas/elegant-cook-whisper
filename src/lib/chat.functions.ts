...
export const chatWithGemini = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data }): Promise<ChatReply> => {
    ...
    const system = `You are the resident cook at MyCookbook, a vintage cookbook. Speak warmly, briefly, with a touch of old-world charm. ${langLine} Two things you do:
