...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#a85d44" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "default" },
      { name: "apple-mobile-web-app-title", content: "CookNotes" },
      { title: "CookNotes — A private cookbook" },
      {
        name: "description",
        content:
          "A vintage-bound cookbook you keep. Save any recipe from the web, scale portions, and cook step by step.",
      },
      { name: "author", content: "CookNotes" },
      { property: "og:title", content: "CookNotes — A private cookbook" },
      {
      ...
      { name: "twitter:title", content: "CookNotes — A private cookbook" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,500;1,500&family=Instrument+Sans:wght@400;500&display=swap",
      },
